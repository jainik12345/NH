...
const OursHotelsSubNavbarDining = () => {
  ...
  if (!hotelInfo) {
    return <div className="text-center py-10">Hotel information not found.</div>;
  }
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center pt-10 pb-10 overflow-hidden">
        ...
        >
          {hotelInfo.navbarDining?.map((dining, index) => (
            <motion.button
              key={index}
              ...
              onClick={() =>
                navigate(
                  `/${hotelSlug}/dining/${encodeURIComponent(
                    dining.diningName.toLowerCase().replace(/\s+/g, "-")
                  )}`
                )
              }
          ...
          {hotelInfo.navbarDining?.map((dining) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col items-center flex-grow">
                ...
                <Link
                  to={`/${hotelSlug}/dining/${encodeURIComponent(
                    dining.diningName.toLowerCase().replace(/\s+/g, "-")
                  )}`}
                >
...
export default OursHotelsSubNavbarDining;
